...
internal object Specs {
    ...
    val APP_DETAILS = AppDetailsSpec(
        title = path("ds:6", 0, 0, 0),
        description = path("ds:6", 0, 10, 0, 1),
        summary = path("ds:6", 0, 10, 1, 1),
        installs = path("ds:6", 0, 12, 9, 0),
        minInstalls = path("ds:6", 0, 12, 9, 1),
        maxInstalls = path("ds:6", 0, 12, 9, 2),
        score = path("ds:7", 0, 6, 0, 1),
        scoreText = path("ds:7", 0, 6, 0, 0),
        ratingCount = path("ds:7", 0, 6, 2, 1),
        reviewCount = path("ds:7", 0, 6, 3, 1),
        ratingsHistogram = path("ds:7", 0, 6, 1),
        priceText = path("ds:4", 0, 2, 0, 0, 0, 1, 0, 2),
        price = path("ds:4", 0, 2, 0, 0, 0, 1, 0, 0),
        currency = path("ds:4", 0, 2, 0, 0, 0, 1, 0, 1),
        isAvailable = path("ds:6", 0, 12, 11, 0),
        offersInAppPurchases = path("ds:6", 0, 12, 12, 0),
        inAppPurchasesPriceRange = path("ds:6", 0, 12, 12, 0),
        appSize = path("ds:3", 0),
        androidVersion = path("ds:3", 2),
        developer = path("ds:6", 0, 12, 5, 1),
        developerId = path("ds:6", 0, 12, 5, 5, 4, 2),
        developerInternalId = path("ds:6", 0, 12, 5, 0, 0),
        developerEmail = path("ds:6", 0, 12, 5, 2, 0),
        developerWebsite = path("ds:6", 0, 12, 5, 3, 5, 2),
        developerAddress = path("ds:6", 0, 12, 5, 4, 0),
        privacyPolicyUrl = path("ds:6", 0, 12, 7, 2),
        genre = path("ds:6", 0, 12, 13, 0, 0),
        genreId = path("ds:6", 0, 12, 13, 0, 2),
        familyGenre = path("ds:6", 0, 12, 13, 1, 0),
        familyGenreId = path("ds:6", 0, 12, 13, 1, 2),
        iconUrl = path("ds:6", 0, 12, 1, 3, 2),
        headerImageUrl = path("ds:6", 0, 12, 2, 3, 2),
        screenshotsUrlsContainer = path("ds:6", 0, 12, 0),
        _screenshotUrl = path(3, 2),
        videoUrl = path("ds:6", 0, 12, 3, 0, 3, 2),
        videoThumbnailUrl = path("ds:6", 0, 12, 3, 1, 3, 2),
        contentRating = path("ds:6", 0, 12, 4, 0),
        contentRatingDescription = path("ds:6", 0, 12, 4, 2, 1),
        containsAds = path("ds:6", 0, 12, 14, 0),
        releaseDate = path("ds:6", 0, 12, 36),
        lastUpdateTimestamp = path("ds:6", 0, 12, 8, 0),
        appVersion = path("ds:3", 1),
        lastUpdateChangelog = path("ds:6", 0, 12, 6, 1),
        isEditorsChoice = path("ds:6", 0, 12, 15, 0),
    )
