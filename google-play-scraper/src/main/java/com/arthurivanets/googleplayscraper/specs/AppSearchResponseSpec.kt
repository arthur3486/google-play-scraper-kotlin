...
internal class AppSearchResponseSpec(
    val featuredAppsSectionIndicator: Path,
    val noResultsSectionIndicator: Path,
    val featuredApp: Path,
    val apps: Path,
    val moreApps: Path,
    val moreResultsToken: Path,
)